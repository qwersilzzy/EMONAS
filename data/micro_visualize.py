...
def plot(genotype_tup, filename, directory, file_type='pdf', view=True):
...
if __name__ == '__main__':
    ...
    genotype_name = 'res_0_architecture'
    # test2333, NSGANet
    try:
        ...
        sys.exit(1)
    save_dir = 'images/micro/test'
    plot([genotype.normal, genotype.normal_concat], genotype_name + "_normal", save_dir)
    plot([genotype.reduce, genotype.reduce_concat], genotype_name + "_reduction", save_dir)
